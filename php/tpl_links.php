 ...
 *
 * 43: <div class="jcomments-links"><?php echo $readmoreLink; ?> <?php echo $commentsLink; ?> <?php echo $hitsCount; ?></div>
 * 92: return '<a class="'.$css.'" href="'.$link.'" title="'.htmlspecialchars($text).'">'.$text.'</a>';
 */
...
?>
<div class="jcomments-links"><?php echo $readmoreLink; ?> <br /> <?php echo $commentsLink; ?> <?php echo $hitsCount; ?></div>
	...
	function getCommentsLink()
	{
		...
		switch($style) {
			case -1:
				...
				break;
			default:
				return $count > 0 ? '<a class="'.$css.'" href="'.$link.'" title="'.htmlspecialchars($text).'">'.$text.'</a>' : '';
				break;
		}
	}
}